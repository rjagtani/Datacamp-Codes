...
#### chapter 1 - Preprocessing,scaling,dummifying and distance function
...
player_distance <- sqrt( (___ - ___)^2 + (___ - ___)^2 )
player_distance
...
############## Chapter 2 - Linkages and Hierarchical Clustering
